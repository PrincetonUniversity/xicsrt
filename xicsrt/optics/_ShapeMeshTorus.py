...
class ShapeMeshTorus(ShapeMesh):
    ...
    def default_config(self):
        ...
        # When surfaces = 0 means the outer surface = concave/concave
        # When surfaces = 1 means the inner surface = concave/convex 
        # When surfaces = 2 means the inner surface = convex/concave
        # When surfaces = 3 means the outer surface = convex/convex
    ...
    # Original surface a concave/concave side of the torus
    ...
    # Modified surface a concave/convex side of the torus
    ...
    # Modified surface a convex/concave side of the torus
    ...
    # Modified surface a convex/convex side of the torus
