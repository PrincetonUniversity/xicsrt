...
from xicsrt.optics._ShapeMeshTorusTest import ShapeMeshTorusTest

@dochelper
class XicsrtOpticMeshToroidalMosaicGraphiteTest(InteractMosaicCrystal,ShapeMeshTorusTest):
    """
    A meshgrid toroidal mosaic graphite optic.
