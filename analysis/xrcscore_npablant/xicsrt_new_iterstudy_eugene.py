...
def get_config(system=None, sight=None):
    ...
    inpath = os.path.join(basepath, 'analysis/xrcscore_npablant/inputs/')
    outpath= os.path.join(basepath, 'results/xrcscore_npablant/')
...
def setup_real_scenario(
    ...
    c_basis[2,:] = np.cross(c_basis[1,:], c_basis[0,:])
...
if __name__ == '__main__':
    ...
    sys.path.append(os.path.join(basepath, 'analysis/xrcscore_npablant/'))
